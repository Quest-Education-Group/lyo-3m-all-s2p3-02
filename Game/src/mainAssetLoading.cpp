...
Node& LoadScene(Node& node)
{
    ...
    sptr<SceneData> Scene4 = AssetLoader::LoadSceneFromFile("res/fbx/Staff_Room_Niveau_test.fbx", AssetLoader::FileType::FBX);
    ...
    EditorSerializer::SaveNode("Staff_Room_Niveau_test.nd",pNode);
