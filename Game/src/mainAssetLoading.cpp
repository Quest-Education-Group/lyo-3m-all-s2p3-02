...
Node& LoadScene(Node& node)
{
    ...
    sptr<SceneData> Scene4 = AssetLoader::LoadSceneFromFile("res/fbx/Player/PlayerFBX.fbx", AssetLoader::FileType::FBX);
    ...
    EditorSerializer::SaveNode("PlayerMeshs.nd",pNode);
